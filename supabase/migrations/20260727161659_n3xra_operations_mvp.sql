...
create table public.operations_transactions (
  ...
  constraint operations_transactions_invoice_revenue_check check (
    invoice_id is null or transaction_type = 'revenue'
  ),
  constraint operations_transactions_deposit_revenue_check check (
    deposit_id is null or transaction_type = 'revenue'
  ),
...
create index operations_parties_account_user_idx
on public.operations_parties(account_user_id)
where account_user_id is not null;

create index operations_parties_created_by_idx
on public.operations_parties(created_by_user_id);

create index operations_products_created_by_idx
...
create index operations_financial_accounts_created_by_idx
...
create index operations_invoices_created_by_idx
...
create index operations_deposits_created_by_idx
...
create index operations_transactions_voided_by_idx
on public.operations_transactions(voided_by_user_id)
where voided_by_user_id is not null;

create index operations_transactions_created_by_idx
