...
async function loadAdminView(adminContext) {
  if (view === "accounts") {
    const accountsController = await import("/account/admin/controllers/accounts.js?v=4");
    ...
    const supportController = await import("/account/admin/controllers/support.js?v=2");
