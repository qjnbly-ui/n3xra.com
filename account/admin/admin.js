...
import { arrangeAdminWorkspace, renderAdminNavigation } from "/account/admin/admin-navigation.js?v=31";
...
async function loadAdminView(adminContext) {
  if (view === "accounts") {
    ...
    const files = await import("/account/admin/files/files.js?v=27");
    ...
    const platformAdmins = await import("/account/admin/controllers/platform-admins.js?v=6");
