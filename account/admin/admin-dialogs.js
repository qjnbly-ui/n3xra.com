...
export function adminDialog(options = {}) {
  ...
  return new Promise((resolve) => {
    ...
    const onKeyDown = (event) => { if (event.key === "Enter" && options.input) finish(input.value); };
