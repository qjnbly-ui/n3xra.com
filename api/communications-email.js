...
exports.loadCommunicationsEmailBrand = loadCommunicationsEmailBrand;
exports.renderCommunicationsEmail = renderCommunicationsEmail;
...
async function loadCommunicationsEmailBrand(database, workspace) {
...
function renderCommunicationsEmail(input) {
    const { brand } = input;
