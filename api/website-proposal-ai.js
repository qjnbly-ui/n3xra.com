...
async function callGroq(context, instruction, targetSections, instructionSource) {
  ...
  const systemInstruction = [
    ...
    "Keep section responsibilities strict. Overview explains the project vision and intended result. Scope explains the build, deliverables, and boundaries. Investment contains plan selection, prices, discounts, waived charges, and billing. Terms contains edit allowances, transfer or ownership conditions, plan-review rights, and other continuing obligations. Do not bury commercial or contractual terms in overview or scope.",
    "The Current N3XRA website plans, pricing, and policies source is the authoritative reference for published N3XRA offerings. An administrator instruction is authoritative for explicit client-specific choices, waivers, exceptions, and special terms and controls when it clearly overrides a general published policy.",
    ...
    "A direction such as additional discount without an exact amount is not an exact discount. Do not choose an amount or percentage for it; identify the missing decision in the summary.",
    "You may polish a contractual rule explicitly supplied by the administrator, but every monetary value, percentage, duration, plan name, waiver, transfer condition, and continuing obligation in the polished language must be supported by cited authoritative evidence.",
