...
function renderProposal() {
  ...
  documentView.innerHTML = `
    ...
    <section class="portal-proposal-section">
      ...
      ${reviewRequired ? `<div class="portal-proposal-note portal-proposal-note-important"><strong>Starter+ during the first ${Number(version.complimentary_months || 0)} months: $0</strong><p>The Starter+ price above shows its value after the complimentary period. N3XRA will review that plan with you ${Number(version.review_notice_days || 45)} days before the free period ends. Paid Starter+ billing will not begin without your written approval. Separately listed domain renewals and outside costs follow their own billing schedules.</p></div>` : ""}
