...
codex.onEvent((method, params) => {
  ...
  if (!["item/started", "item/completed", "item/agentMessage/delta", "turn/completed", "account/login/completed", "account/updated", "thread/tokenUsage/updated", "worker/disconnected"].includes(method)) return;
