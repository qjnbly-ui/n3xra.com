...
export const MAP_SYMBOLS = [
  ...
  ["hydrant", "Fire hydrant"], ["pump", "Pump"], ["manhole", "Sewer manhole"],
  ["cleanout", "Cleanout"], ["well", "Well"], ["tank", "Storage tank"],
  ["backflow", "Backflow assembly"], ["storm-inlet", "Storm inlet"], ["boundary", "Boundary"],
] as const;
...
const SYMBOL_CONTENT: Record<string, string> = {
  ...
  boundary: '<path d="M4 9V4h5m6 0h5v5m0 6v5h-5m-6 0H4v-5"/><path d="M8 12h8" stroke-dasharray="2 2"/>',
};
...
export const STANDARD_LAYER_PRESETS: LayerPreset[] = [
  ...
  { key: "lift-station", group: "Sanitary sewer", name: "Lift stations", description: "Wastewater lift and pumping stations", geometryType: "point", iconKey: "pump", color: "#168A52", standardNote: "Green identifies sewer infrastructure with a dedicated pump symbol.", fields: [{ label: "Station number", fieldType: "text" }, { label: "Pump count", fieldType: "number" }, { label: "Capacity (gpm)", fieldType: "number" }] },
